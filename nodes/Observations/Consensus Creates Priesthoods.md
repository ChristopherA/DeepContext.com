---
created: 2026-04-20
tagline: When a community converges on a shared vocabulary, the participants who helped create it acquire natural authority and newcomers face a learn-or-leave choice — structural dynamic, not moral failing
brief_summary: A Retrospective Observation that convergence on a shared vocabulary produces a structural authority asymmetry. Participants who shaped the vocabulary acquire natural authority over its use; newcomers face a choice between learning an ontology they did not help create or forming a parallel community with their own language. The dynamic is not a moral failing of the converging community — it is a structural property of convergence as a move. The claim rests on the gist's argument citing the reinvention-under-new-names pattern in knowledge communities and the Real Academia Española / Buenos Aires street-usage gap as canonical instances; the record's limit is that it generalizes from specific cases rather than from a frequency count across converged vocabularies at scale.
---
...
- Allen, Christopher. "Wikilinks and Named Edges," 2026 — the "Why vocabulary diversity matters across systems" section supplies the full argument this Observation compresses, including both the reinvention-under-new-names pattern and the Real Academia Española / Buenos Aires example.
...
- informed_by::[[Wikilinks and Named Edges Gist (Christopher Allen, 2026)]]
  - The gist is the direct source for both the analytical argument and the two named cases (concept reinvention, RAE/Buenos Aires) this Observation rests on.
