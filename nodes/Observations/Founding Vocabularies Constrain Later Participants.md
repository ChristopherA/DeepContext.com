---
created: 2026-04-21
tagline: The terms a project's architects choose early calcify into the group's vocabulary faster than the architects intend, constraining later participants who encounter the terms as given
brief_summary: A Retrospective Observation that architects of a project select terms during founding choices (framing metaphors, predicate names, form-type labels) and those terms calcify into the group's vocabulary through repeated use -- often before the broader participant set has a chance to propose alternatives. The constraint operates structurally regardless of whether the chosen terms are good: what later participants encounter is not a vocabulary under negotiation but a vocabulary already in use, which shifts their position from proposer to either adopter or dissenter. The Observation is distinct from Consensus Creates Priesthoods -- priesthoods name the post-convergence authority dynamic; founding vocabularies name the pre-convergence architect-imposition step that precedes it.
---
...
- [[Creating Shared Language and Shared Artifacts Post (Christopher Allen, 2009)]] -- the framing this Observation sits within: shared language emerges from deliberate convention-setting, and the participants who set the convention shape the vocabulary's later trajectory.

- [[Deep Context Shared Languages Post (Christopher Allen, 2014)]] -- the elaboration of how shared language accumulates and the role of architectural choices in shaping later participation.

- Kaminski, Peter, 2026 (with attribution consent) -- the architect-imposition risk named directly: architects building the space risk over-influencing later users by "poisoning their terminologies with precision," and the importance of preserving room for participants to say "I think it is xyz" rather than treating the architectural name as canonical.

- Gracia, Victoria. *A Rose is a Rose is a Rose*, 2026 (with attribution consent) -- the dissent-from-afterwards position on taxonomic predicate use, and the refusal to offer an alternative that would land as competing authority rather than as a genuine proposal.

- Allen, Christopher. *On Roses and Edges*, 2026 -- the architect-side awareness of prototype-projection risk.

- Allen, Christopher. *Poppies in the Gravel*, 2026 -- the architect-side awareness of "label going on too fast" and the contradicts-card-placed-too-early phenomenon.

- W3C Verifiable Credentials Data Model (W3C Recommendation) -- the standards-body case where "subject" was adopted to gain cross-organizational acceptance, illustrating how a politically-pragmatic term choice constrains later architectural reasoning.

- The wiki tradition's distinction between page-creators and gardeners (publicly documented across multiple wiki communities) -- the structural role distinction that underwrites why founding vocabularies stay entrenched even as the wiki grows.

## Relations

- informs_downstream::[[Terms Become Common Through Unanimity, Not Precedent]]
...
- informed_by::[[Wikis Without Curation Drift Toward Write-Only]]
  - The write-only failure mode is adjacent: both describe vocabularies accreting faster than participants can tend them. The write-only Observation focuses on the failure of maintenance; this Observation focuses on the failure of invitation at the moment of introduction.
...
- informs_downstream::[[Adopt Self-Sovereign Graph Publication]]
  - Self-sovereign graph publication is the architectural response to this Observation's dynamic. If founding vocabularies calcify, standing up a parallel graph (with grafts where helpful, and scion-of when upstream tracking is desired) is the structural escape hatch that lets later participants carry the practice forward under their own cryptographic identity rather than being bound to the founding choices — vocabulary divergence gets an exit at the identity layer, not just at the contribution layer.
