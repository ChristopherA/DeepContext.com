...
- "2026-04-09 Wilderness Thursday — Transcript" (IFP Wilderness) -- Peter Kaminski on architect-imposition risk and on preserving the possibility that "node" is the architectural name but not the canonical one in other contexts.

- Gracia, Victoria. "A Rose is a Rose is a Rose" (IFP Wilderness Comms, 2026-04-06) -- the dissent-from-afterwards position on taxonomic predicate use, and the refusal to offer an alternative that would land as competing authority.

- Allen, Christopher. "On Roses and Edges" (IFP Wilderness Comms, 2026-04-06) -- the architect-side awareness of prototype-projection risk.

- Allen, Christopher. "Poppies in the Gravel" (IFP Wilderness Comms, 2026-04-05) -- the architect-side awareness of "label going on too fast."

- "2026-04-16 Wilderness Thursday — Transcript" (IFP Wilderness) -- Christopher Allen on the Verifiable Credentials community's "subject" adoption as an adjacent case of founding-vocabulary constraint at standards-body scale.
