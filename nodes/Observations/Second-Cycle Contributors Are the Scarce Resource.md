---
created: 2026-04-20
tagline: In sustained knowledge communities, the bottleneck is not first-cycle contribution but second-cycle continuation — roughly one in four first-cycle contributors continues
brief_summary: A Retrospective Observation that the attrition at the first-to-second-cycle contributor transition is consistently high across sustained knowledge communities and that the second cycle is where most communities thin. Grounded in a recurring observation across several communities of comparable scale (roughly five second-cycle contributors per twenty first-cycle contributors) and in a four-tier cascade reported for a large-scale online community (approximately 300,000 members through 30,000 active users through 3,000 regular contributors to 30 sustained long-term contributors, recorded in Allen's 2008 Power Laws post). The direction of the attrition is the durable finding; the specific ratio is community-specific and approximate. The Observation is a specific tier-transition inside the general power-law distribution shape.
---
