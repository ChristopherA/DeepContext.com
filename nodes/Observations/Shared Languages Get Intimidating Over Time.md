...
brief_summary: A Retrospective Observation that shared-language communities accumulate vocabulary faster than newcomers can comfortably enter it, producing a catch-up burden that filters who stays in the conversation. The dynamic is observable in the project's own parent community (IFP Wilderness), in long-running wikis (the Wikipedia entrenchment pattern), and in scaled games and online communities where early adopters occupy senior positions and hold them. The record's limit is that it reconstructs the pattern from specific communities rather than measures it at scale across comparable cases; the direction is the durable finding, the rate at which intimidation accrues is community-specific.
---
...
- "2026-04-09 Wilderness Thursday — Transcript" (IFP Wilderness) -- Peter Kaminski on catch-up burden; Christopher Allen's acknowledgement that the group has already made it hard for later joiners.

- "2026-04-16 Wilderness Thursday — Transcript" (IFP Wilderness) -- Christopher Allen on the Wikipedia entrenchment pattern and the game-amplification-without-attenuation analogy.
