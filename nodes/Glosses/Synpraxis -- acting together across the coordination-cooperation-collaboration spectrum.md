...
- informed_by::[[Synpraxis Domain]]↗
  - The fuller Domain exposition lives in the Deep Context Community lead's personal knowledge garden — the 15-dimension spectrum tables, the precondition stack from privacy through trust to collaboration, the anti-pattern taxonomy, and the cross-cutting consensus mechanism (machine, negotiated, emergent). This Gloss captures the term for local use in this graph; the Domain carries the fuller treatment and its references (Mattessich, Ostrom, Deutsch, Bratman, Schneier, Nowak, Lamport, and others).
