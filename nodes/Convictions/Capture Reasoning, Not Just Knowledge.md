...
- Allen, Christopher. "Reasoning Fidelity" value in personal knowledge garden (2026-03) -- the original framing this Conviction adapts. The local version shifts the scope from a single owner's reasoning to the reasoning of multiple contributors and adds composition with [[Vocabulary Diversity Is a Feature]].
