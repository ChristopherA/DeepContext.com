...
- informs_downstream::[[Adopt Self-Sovereign Graph Publication]]
  - Self-sovereign graph publication is load-bearing for this Conviction at the architecture layer. Without it, a contributor whose vocabulary diverges would have to converge on the parent's vocabulary or stop participating; with it, they stand up their own graph (claiming scion-of lineage when upstream tracking is desired, otherwise diverging freely) and continue the practice under their own cryptographic identity while holding their own vocabulary. The Conviction commits the graph to preserving diversity at the edge-and-annotation layer; the Self-Sovereign Graph Publication Decision is what preserves it at the graph-instance layer.
