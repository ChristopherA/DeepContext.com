---
created: 2026-04-24
tagline: Christopher Allen's 2026 Musing extending the Principal Authority framework to AI agents -- agents as delegated instruments without agency of their own, with the strategic-vs-tactical-oversight reframe addressing what agency means at AI speeds
brief_summary: Blockchain Commons Musing, published 2026-04-22, that extends the 2021 Principal Authority framework to agentic AI. The post argues that AI agents lack agency themselves -- they are delegated instruments that either preserve or threaten human agency depending on the governance structures around them. Three load-bearing moves: (1) reframing what agency requires at AI speeds (tactical per-action approval becomes impossible, so maintaining agency requires shifting to strategic oversight -- definitions, scope, audit); (2) treating agents under agency-law duties (good faith, loyalty to the principal's interests, reasonable care, transparency, minimal data collection) rather than as autonomous parties; (3) the Credit Issue ("the ghost is visible now") -- AI makes attribution evasion impossible, raising the question of how to distinguish human-authored, AI-supported, and AI-driven work, with role-based metadata (Author, Editor, Designer, etc.) as a candidate solution. The post connects directly to Wyoming's 2021 personal-digital-identity statute and Utah's 2026 SEDI amendment with its Duty of Loyalty. Composes with Allen's earlier Principal Authority article (2021) -- the Musing is the AI-specific extension of the same agency-as-substrate framework. Substrate for DeepContext.com's Human Authority Over Augmentation Systems Conviction; substrate for the not-yet-seeded Authentic Collaboration Requires Agency Conviction (planned).
---
...
- The Credit Issue framing motivates why DeepContext's `authored_by::` convention is load-bearing for AI-supported work. A graph with no authorship convention loses the AI-supported vs human-authored distinction the Musing argues is increasingly necessary.
