...
- composes_with::[[Newcomers Cross the Second-Cycle Threshold]]
  - Adjacent specializations of the second-cycle target at different design layers. The newcomer-transition Aspiration targets the acknowledgment and follow-up surface; this Aspiration targets the trait-cultivation surface. Both are load-bearing for the contributor-level second cycle; neither subsumes the other.
