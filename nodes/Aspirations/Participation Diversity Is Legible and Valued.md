---
created: 2026-04-20
tagline: The practice's measurement surfaces and norms treat different forms of participation — authoring, responding, curating, onboarding, connecting — as first-class kinds rather than as different volumes of a single contribution measure
brief_summary: An Aspiration that specializes the plural-participation stance at the form-plurality layer, adjacent to Contributors Across Vocabularies Can Collaborate (which specializes it at the vocabulary-plurality layer). The target is that the practice's measurement surfaces and practitioner norms recognize authoring, responding, curating, onboarding, and connecting as first-class participation forms rather than as different volumes of a single contribution measure. Grounded in Participation Takes Different Forms Not Different Levels (the four-lens graph analysis of a plural-contributor corpus). The gap is that volume-only language defaults in practitioner discussion even though the predicate vocabulary already distinguishes some forms; the work is to name forms in conventions, produce form-sensitive measurement surfaces, acknowledge form-plurality in curation rituals, and consider whether curation itself needs a first-class predicate.
---
...
- `[[Participation Takes Different Forms Not Different Levels]]` — the grounding Observation that identifies volume-only measurement as a mismeasurement and names form-plurality as the alternative frame.

## Relations

- grounded_in::[[Participation Takes Different Forms Not Different Levels]]
  - The Observation supplies the empirical grounds and the framing; this Aspiration targets the practice-level response. Without the Observation, the Aspiration would read as a preference for richer measurement; with it, the Aspiration is a specific response to a specific measurement artifact.

- grounded_in::[[Vocabulary Diversity Is a Feature]]
  - The sovereignty stance that justifies plural-participation at the vocabulary layer extends to plural-participation at the form layer. The same argument that vocabulary-plurality preserves encoded meaning argues that form-plurality preserves participation modes the volume-only measure would erase.

- grounded_in::[[The Second Cycle of Contribution Happens]]
  - A second cycle reached by narrowing to one participation form is not the plural-participation second cycle the project holds; the form-plurality Aspiration is the specific form-layer expression of what sustained plural participation requires.
...
- informs::[[Newcomers Cross the Second-Cycle Threshold]]
  - Second-cycle contribution may arrive in a different form than first-cycle contribution. The contributor-transition Aspiration's progress-recognition markers need to be form-sensitive for the transition to be measurable; this Aspiration's work is what makes form-sensitive measurement possible.
