---
created: 2026-04-21
tagline: The curator's first operational move in any curation pass is to name what each contribution added — before proposing revisions — so subsequent revision is legible as collaboration rather than override
brief_summary: "A recurring curator move. Before proposing any revision to a contribution, name what the contribution added: the node it introduced, the gap it closed, the edge it made tractable, the distinction it surfaced. Acknowledgment is not rhetorical courtesy — it is the specific early step that makes subsequent revision legible as collaboration rather than as silent override. Without it, revision is experienced by the contributor as erasure; with it, revision sits inside a recognized contribution and the contributor can engage with the revision as participation rather than as rejection."
---
...
- grounded_in::[[Pride and Humility Are Both Cultivable]]
...
- grounded_in::[[Meaningful Wiki Contribution Requires Both Pride and Humility]]
