---
created: 2026-04-19
tagline: Observations describe concrete conditions for update, downgrade, or abandonment; no-revision Observations are misidentified
brief_summary: A commitment that every Observation's body describes concrete conditions under which the observation would be updated, downgraded, or abandoned — new measurement contradicting, contradicting record, promotion of a premise to empirical status, resolution of a contest. An Observation with no conceivable revision condition is likely misidentified as a Conviction or a Contract Requirement. The rule distinguishes Observation's accountability — claims about the world that evidence can revise — from the other forms' accountability modes.
---
