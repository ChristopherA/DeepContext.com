---
created: 2026-04-19
tagline: Aspirations carry Current Gap, Work It Asks, and Progress Recognition sections — together they make the directional claim answerable
brief_summary: A bundled commitment covering three body sections that together make an Aspiration accountable for its directional claim. Current Gap reports where the project stands relative to the target, naming concrete shortfalls. Work It Asks names moves the project can actually take given current resources, not a wish list depending on uncontrolled conditions. Progress Recognition names observable markers by which movement toward the target would be seen. The three sections bundle because each is incomplete without the others: Gap without Work is passive reporting; Work without Progress is activity without accountability; Markers without Gap and Work have nothing to measure against.
---
...
- **Gap catches Conviction mislabel.** An Aspiration with no gap to acknowledge is a Conviction — the project holds the stance now, which is what Convictions record. The Gap section diagnoses the mislabel at the authoring moment by forcing an honest current-state account.
- **Work catches inspirational rhetoric.** An Aspiration whose work depends on uncontrolled conditions is a wish, not a directional commitment — the project cannot progress on its own terms. The Work section diagnoses this by requiring project-driven moves to be named separately from externally-contingent ones.
- **Progress Recognition catches wishful thinking.** An Aspiration whose progress is unrecognizable admits any amount of actual progress, including none, while still appearing coherent. The Markers section diagnoses this by requiring observable signs of movement.
