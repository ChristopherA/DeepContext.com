---
created: 2026-04-19
tagline: A Pattern's Forces name at least two competing demands in genuine tension; a Force nobody disagrees with is a value, not a Force
brief_summary: A commitment that every Pattern's `## Forces` section names at least two competing demands or constraints in genuine tension. Forces are the engine of a Pattern: without them, the Problem reads as a complaint and the Solution reads as advice. A Force that nobody would disagree with — a uniformly-desired property, an obvious good — is not a Force; it is a value. Genuine Forces pull against each other, and the Pattern's Solution is the move that resolves or brokers the tension.
---
